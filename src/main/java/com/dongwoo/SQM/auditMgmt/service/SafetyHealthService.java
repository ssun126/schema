...
public class SafetyHealthService {
    ...
    public void saveAuthData(String tableData, String type, MultipartFile[] fileNames) throws IOException {
        ...
        if (fileNames != null && fileNames.length > 0 && authMgmtDTO.getAUTH_SEQ()  > 0) {
            ...
            for (int i = 0; i < fileNames.length; i++) {
                ...
                SafetyHealthDTO dto = new SafetyHealthDTO();
                ...
                log.info("dto: " + dto);
                int rtCnt = safetyHealthRepository.insertFileInfo(dto);  // insert
