    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(requests -> requests
                        ...
                        .requestMatchers(HttpMethod.POST, "/sendIsoAuthData", "/multiLanguage/saveMultiLanguage", "/findDW", "/findCompanyID", "/findCompanyPW", "/otp", "/idpwCheck").permitAll()  // Allow POST without authentication
                        // 관리자 권한만 가능
